        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          ...
          <div>
            ...
            <p className="text-white/60 mb-4 leading-relaxed">
              {settings?.slogan || 'Cửa hàng guitar cao cấp hàng đầu Việt Nam. Mang âm nhạc đến gần hơn với bạn.'}
            </p>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="flex items-start gap-3 text-white/60">
                ...
                <span>{settings?.address || '123 Đường ABC, Quận XYZ, Hà Nội'}</span>
              </li>
              <li className="flex items-center gap-3 text-white/60">
                <Phone className="w-5 h-5 text-amber-500 shrink-0" />
                <span>{settings?.phone || '1900 1234'}</span>
              </li>
              <li className="flex items-center gap-3 text-white/60">
                <Mail className="w-5 h-5 text-amber-500 shrink-0" />
                <span>{settings?.email || 'support@guitarnova.vn'}</span>
              </li>
            </ul>
          </div>
